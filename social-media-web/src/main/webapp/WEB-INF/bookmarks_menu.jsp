    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <ul style="list-style: none; display: inline;">
                <c:forEach var="i" begin="1" end="${requestScope.bookmarksPage.amountPages}">
                    <li style="display: inline;"><a href="#"
                                                    onclick="postMainDiv('/user/bookmarks/${i}', this)">${i}&nbsp;</a>
                    </li>
                </c:forEach>
            </ul>
            <c:forEach items="${requestScope.bookmarksPage.posts}" var="post">
